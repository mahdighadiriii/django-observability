...
class ObservabilityMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request: HttpRequest, response: HttpResponse) -> HttpResponse:
        ...
        try:
            ...
            # Log response
            if self.structured_logger:
                self.structured_logger.log_request_end(request, response, duration, correlation_id)
    ...
    def process_exception(self, request: HttpRequest, exception: Exception) -> Optional[HttpResponse]:
        ...
        try:
            ...
            logger.error(
                ...
                exc_info=True,
                extra={"correlation_id": correlation_id, "original_exception": str(exception)}
            )
    ...
    async def __call__(self, request: HttpRequest) -> HttpResponse:
        ...
        try:
            ...
            if self.tracing_manager and span:
                ...
                self.tracing_manager.end_request_span(span, request, response_obj, duration)
